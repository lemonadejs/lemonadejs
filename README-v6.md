...
npm run build       # dist/v6: ESM + CJS + minified IIFE + d.ts, with a hard 8 KB gzip budget
npm run test:v5     # legacy v5 suite (mocha, dist/lemonade.js)
```

v5 remains untouched at `dist/lemonade.js` (`lemonadejs/v5` export).
